...
public class AdminElementarySmranchitraList extends AppCompatActivity {
    ...
    public void onBackPressed() {
        Intent intent = new Intent(AdminElementarySmranchitraList.this , AdminDashboard.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_elementary_smranchitra_list);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(AdminElementarySmranchitraList.this,AdminElementarySmranchitraShower.class);
