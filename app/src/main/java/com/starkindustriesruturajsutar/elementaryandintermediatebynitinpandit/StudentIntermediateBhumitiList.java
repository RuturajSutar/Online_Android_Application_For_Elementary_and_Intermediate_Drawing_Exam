...
public class StudentIntermediateBhumitiList extends AppCompatActivity {
    ...
    public void onBackPressed() {
        Intent intent = new Intent(StudentIntermediateBhumitiList.this , StudentDrawingTypesIntermediate.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_intermediate_bhumiti_list);
        ...
        ref=database.getReference().child("Images").child("24");
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(StudentIntermediateBhumitiList.this,StudentIntermediateBhumitiShower.class);
