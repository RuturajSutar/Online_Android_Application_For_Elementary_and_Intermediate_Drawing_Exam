...
public class AdminIntermediateBhumitiUpload extends AppCompatActivity {
    ...
    public void onBackPressed() {
        Intent intent = new Intent(AdminIntermediateBhumitiUpload.this , AdminDrawingTypesIntermediate.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_intermediate_bhumiti_upload);
        ...
        camera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (myimage.isEmpty()){
                    ...
                    Toast.makeText(AdminIntermediateBhumitiUpload.this, "Error in Adding Complaint", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void uploadImageToFirebase(final String name, Uri contentUri) {
        ...
        final StorageReference image = storageReference.child("Images").child("24/"+name);
        image.putFile(contentUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                image.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(final Uri uri) {
                        ...
                        mRef= FirebaseDatabase.getInstance().getReference().child("Images").child("24").child(my_image_name);
                        Map<String,Object> insertValues=new HashMap<>();
                        insertValues.put("URI",uri.toString());
                        insertValues.put("FileName",name);
                        mRef.setValue(insertValues);
                        Toast.makeText(AdminIntermediateBhumitiUpload.this, "Image is Uploaded", Toast.LENGTH_LONG).show();
                        mProgress.dismiss();
                    }
                });
            ...
            public void onFailure(@NonNull Exception e) {
                mProgress.dismiss();
                Toast.makeText(AdminIntermediateBhumitiUpload.this, "Image Uploading is Failed", Toast.LENGTH_LONG).show();
            }
        });
    }
