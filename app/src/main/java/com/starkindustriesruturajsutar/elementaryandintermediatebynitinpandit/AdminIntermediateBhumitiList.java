...
public class AdminIntermediateBhumitiList extends AppCompatActivity {
    ...
    public void onBackPressed() {
        Intent intent = new Intent(AdminIntermediateBhumitiList.this , AdminDashboard.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_intermediate_bhumiti_list);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(AdminIntermediateBhumitiList.this,AdminIntermediateBhumitiShower.class);
