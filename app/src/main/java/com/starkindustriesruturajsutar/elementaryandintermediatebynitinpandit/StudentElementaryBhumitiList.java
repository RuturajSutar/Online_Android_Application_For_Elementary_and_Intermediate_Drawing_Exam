...
public class StudentElementaryBhumitiList extends AppCompatActivity {
    ...
    public void onBackPressed() {
        Intent intent = new Intent(StudentElementaryBhumitiList.this , StudentDrawingTypesElementary.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_elementary_bhumiti_list);
        ...
        ref=database.getReference().child("Images").child("14");
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(StudentElementaryBhumitiList.this,StudentElementaryBhumitiShower.class);
