...
public class AdminIntermediateBhumitiShower extends AppCompatActivity {
    ...
    public void onBackPressed() {
        Intent intent1 = new Intent(AdminIntermediateBhumitiShower.this , AdminIntermediateBhumitiList.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_intermediate_bhumiti_shower);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                image.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(AdminIntermediateBhumitiShower.this, "Error in Loading Files", Toast.LENGTH_SHORT).show();
                    }
                });
