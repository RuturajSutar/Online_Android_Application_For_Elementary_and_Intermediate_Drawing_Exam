...
public class AdminElementaryBhumitiList extends AppCompatActivity {
    ...
    public void onBackPressed() {
        Intent intent = new Intent(AdminElementaryBhumitiList.this , AdminDashboard.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_elementary_bhumiti_list);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(AdminElementaryBhumitiList.this,AdminElementaryBhumitiShower.class);
