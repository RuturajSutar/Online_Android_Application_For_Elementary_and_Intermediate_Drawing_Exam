...
public class AdminAccount extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                String my_email=dataSnapshot.child("Email").getValue().toString();
                String my_mobile=dataSnapshot.child("Mobile").getValue().toString();


                two.setText(my_email);
    ...
    public void onBackPressed() {
        Intent intent1 = new Intent(AdminAccount.this , AdminDashboard.class);
