...
public class StudentIntermediateSthirchitraList extends AppCompatActivity {
    ...
    public void onBackPressed() {
        Intent intent = new Intent(StudentIntermediateSthirchitraList.this , StudentDrawingTypesIntermediate.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_intermediate_sthirchitra_list);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(StudentIntermediateSthirchitraList.this,StudentIntermediateSthirchitraShower.class);
